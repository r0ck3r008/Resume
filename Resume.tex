...
\begin{minipage}[t]{0.45\textwidth}
    ...
    \item[]\textit{Popular Frameworks}
            ...
            \setlength\itemsep{-0.25em}
                ...
                \item[]\textbf{Radare2}\hspace{6pt}\meter{3}
            \end{itemize}
            \end{multicols}
...
\begin{itemize}[noitemsep,nolistsep]
    \item[]\textbf{Malware Analysis \hfill \textit{Ongoing}}
        \begin{itemize}[leftmargin=*]
            \setlength\itemsep{-0.25em}
            \item[\textbullet]\textit{Ghidra, x64DBG, Python, Radare2} \hfill \href{https://github.com/r0ck3r008/malware-analysis}{{\scriptsize https://github.com/r0ck3r008/kademgo}}
            \item[\textbullet]Malware sample analysis reports with Ghidra/Rizin workspaces and memory dumps
            \item[\textbullet]Currently analyzed sample families: \textit{Carberp (2008) and AveMariaRAT (2020)}
        \end{itemize}
